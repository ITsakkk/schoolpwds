...
if (!empty($search_id)) {
    $query .= " WHERE tblresourcetype.ResourceTypeID  = $search_id";
}
    ...
    <div class="content px-4">
        <div class="row">
            ...
            <div class="col-lg-3 py-2 p-0 text-start">
                <form class="form-inline" id="searchForm" action="display_resourcetype.php" method="GET">
            ...
            <div class="col-3 py-2 p-0 text-start">
                <a href="display_resourcetype.php" class="btn btn-primary "><i class="fa-solid fa-arrows-rotate"></i>
                    Refesh</a>
            </div>
            <div class="col-6 py-2 p-0 text-end">
                <a href="form_resourcetype.php" class="btn btn-primary "><i class="fa-solid fa-circle-plus"></i>
                    Add New</a>
            </div>
        </div>
        <div class="row d-flex align-items-center p-3 bg-primary text-white">
            <div class="col-lg-4 fs-5 font-weight-bold">ID</div>
            <div class="col-lg-4 fs-5 font-weight-bold">Resource Type</div>
            <div class="col-lg-4 fs-5 font-weight-bold">Action</div>
        </div>
        <?php
        ...
        <div class="row d-flex align-items-center p-2 border DFDFDF <?php echo $bg_color_class; ?>">
            <div class="col-lg-4 font-weight-bold text-truncate"><?php echo $row['ResourceTypeID'] ?></div>
            <div class="col-lg-4 text-truncate"><?php echo $row['ResourceTypeName'] ?></div>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="seeMoreDropdown">
                        <li><a class="dropdown-item"
                                href="edit_resourcetype.php?ResourceTypeID=<?php echo $row['ResourceTypeID'] ?>"><i
                                    class="fa-solid fa-pencil fs-sm-7"></i>
                                Edit</a></li>
                        <li><a class="dropdown-item"
                                href="view_resourcetype.php?ResourceTypeID=<?php echo $row['ResourceTypeID'] ?>"><i
                                    class="fa-solid fa-magnifying-glass fs-sm-7"></i>
                                View Form</a>
                        </li>
                        <li><a class="dropdown-item text-danger"
                                href="delete_resourcetype.php?ResourceTypeID=<?php echo $row['ResourceTypeID'] ?>"><i
        ...
        <?php
            ...
            // Pagination links
            $query = "SELECT COUNT(*) AS count FROM tblresourcetype";
            $rs_result = mysqli_query($conn, $query);
